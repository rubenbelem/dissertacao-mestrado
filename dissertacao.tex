...
\preambulo{Dissertação apresentada ao Programa de Pós-Graduação em Informática da Universidade Federal do Amazonas como requisito para obtenção do grau de Mestre em Informática.}
% ---
...
% Introdução
% ----------------------------------------------------------
\input{chapters/indroducao.tex}

% ---------------------
% Trabalhos relacionados
% ---------------------
\input{chapters/trabalhos_relacionados}

% ---------------------
% Referencial Teórico
% ---------------------
\input{chapters/referencial_teorico}
\afterpage{\blankpage}
